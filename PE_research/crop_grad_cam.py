...
if __name__ == '__main__':
    ...
    file_name = list(glob.glob('/home/mel/PE_research/opendata/PAT010/1/*dcm'))
    file_name_sample = random.sample(file_name, k = 3)
