...
class MixNet(nn.Module):
    ...
    def __init__(self, net_type='mixnet_s', input_size=224, num_classes=1000, stem_channels=16, feature_size=1536, depth_multiplier=1.0):
        ...
        # stem convolution
        self.stem_conv = Conv3x3Bn(1, stem_channels, 2)
...
def mixnet_l():
    return MixNet(net_type='mixnet_l', input_size=400, num_classes=2, stem_channels=16, feature_size=1536, depth_multiplier=1.0)

if __name__ == '__main__':
    net = MixNet(net_type='mixnet_l', input_size=400, num_classes=2, stem_channels=16, feature_size=1536, depth_multiplier=1.0)
    print(net)
    x_image = Variable(torch.randn(1, 1, 400, 400))
    y = net(x_image)
    print(y.shape)